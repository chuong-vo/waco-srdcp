...
<simconf>
  ...
  <simulation>
    <title>waco-srdcpt-chain-5-nodes</title>
    ...
    <motetype>
      ...
      <source EXPORT="discard">[CONTIKI_DIR]/examples/simulation/waco-srdcp/example-waco-srdcp-15.c</source>
      <commands EXPORT="discard">make example-waco-srdcp-15.sky TARGET=sky</commands>
      <firmware EXPORT="copy">[CONTIKI_DIR]/examples/simulation/waco-srdcp/example-waco-srdcp-15.sky</firmware>
...
if (LOG_DIR == null || LOG_DIR.isEmpty()) {
  LOG_DIR = new java.io.File("/home/chuongvo/waco/examples/waco-srdcp/sim/waco-srdcp-random-15-nodes").getPath();
}      // vd: "/home/user/cooja-logs" hay "C:\\temp\\cooja"
var LOG_BASENAME         = "waco-srdcp-chain-15-nodes";      // sẽ tạo &lt;LOG_DIR&gt;/&lt;LOG_BASENAME&gt;.log và *_dc.log
