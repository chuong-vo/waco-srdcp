...
<simconf>
  ...
  <simulation>
    <title>tsch-rpl-random-5-nodes</title>
    ...
    <motetype>
      ...
      <source EXPORT="discard">[CONTIKI_DIR]/examples/simulation/tsch-rpl/example-tsch-rpl.c</source>
      <commands EXPORT="discard">make example-tsch-rpl.z1 TARGET=z1</commands>
      <firmware EXPORT="copy">[CONTIKI_DIR]/examples/simulation/tsch-rpl/example-tsch-rpl.z1</firmware>
...
var LOG_BASENAME         = "tsch-rpl-random-5-nodes";
