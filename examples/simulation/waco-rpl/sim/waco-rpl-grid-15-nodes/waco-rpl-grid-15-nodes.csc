...
<simconf>
  ...
  <simulation>
    <title>waco-rpl-grid-15-nodes</title>
    ...
    <motetype>
      ...
      <source EXPORT="discard">[CONTIKI_DIR]/examples/simulation/waco-rpl/example-waco-rpl-15.c</source>
      <commands EXPORT="discard">make example-waco-rpl-15.sky TARGET=sky</commands>
      <firmware EXPORT="copy">[CONTIKI_DIR]/examples/simulation/waco-rpl/example-waco-rpl-15.sky</firmware>
  ...
  <plugin>
    ...
    <plugin_config>
      <script>// Đọc đường dẫn log từ biến môi trường do script shell cung cấp.
// Nếu không có, dùng đường dẫn tương đối làm dự phòng (chạy từ GUI).
var LOG_DIR              = java.lang.System.getenv("WACO_LOG_DIR") || ".";

var LOG_BASENAME         = "waco-rpl-grid-15-nodes";
