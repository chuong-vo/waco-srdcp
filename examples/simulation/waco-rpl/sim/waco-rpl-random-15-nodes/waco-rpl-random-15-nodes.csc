...
<simconf>
  ...
  <simulation>
    <title>waco-rpl-random-15-nodes</title>
...
if (LOG_DIR == null || LOG_DIR.isEmpty()) {
  LOG_DIR = new java.io.File("/home/chuongvo/waco/examples/waco-rpl/sim/waco-rpl-random-15-nodes").getPath();
}
var LOG_BASENAME         = "waco-rpl-random-15-nodes";
