...
<simconf>
  ...
  <simulation>
    <title>waco-rpl-random-5-nodes</title>
    ...
    <motetype>
      ...
      <source EXPORT="discard">[CONTIKI_DIR]/examples/simulation/waco-rpl/example-waco-rpl.c</source>
      <commands EXPORT="discard">make example-waco-rpl.sky TARGET=sky</commands>
      <firmware EXPORT="copy">[CONTIKI_DIR]/examples/simulation/waco-rpl/example-waco-rpl.sky</firmware>
...
if (LOG_DIR == null || LOG_DIR.isEmpty()) {
  LOG_DIR = new java.io.File("/home/chuongvo/waco/examples/waco-rpl/sim/waco-rpl-random-5-nodes").getPath();
}
var LOG_BASENAME         = "waco-rpl-random-5-nodes";
