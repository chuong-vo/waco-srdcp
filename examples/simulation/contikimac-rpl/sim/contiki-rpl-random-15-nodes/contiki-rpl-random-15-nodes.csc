...
<simconf>
  ...
  <simulation>
    <title>contiki-rpl-random-15-nodes</title>
    ...
    <motetype>
      ...
      <source EXPORT="discard">[CONTIKI_DIR]/examples/simulation/contikimac-rpl/example-contikimac-rpl-15.c</source>
      <commands EXPORT="discard">make example-contikimac-rpl-15.sky TARGET=sky</commands>
      <firmware EXPORT="copy">[CONTIKI_DIR]/examples/simulation/contikimac-rpl/example-contikimac-rpl-15.sky</firmware>
    ...
    <!-- 15-node random layout (coordinates match SRDCP random) -->
    <mote>
      <breakpoints />
      <interface_config>
...
if (LOG_DIR == null || LOG_DIR.isEmpty()) {
  LOG_DIR = new java.io.File("/home/chuongvo/waco/examples/contikimac-rpl/sim/contiki-rpl-random-15-nodes").getPath();
}
var LOG_BASENAME         = "contiki-rpl-random-15-nodes";
