...
<simconf>
  ...
  <simulation>
    <title>contikimac-srdcp-random-5-nodes</title>
    ...
    <motetype>
      ...
      <source EXPORT="discard">[CONTIKI_DIR]/examples/simulation/contikimac-srdcp/example-contikimac-srdcp.c</source>
      <commands EXPORT="discard">make example-contikimac-srdcp.sky TARGET=sky</commands>
      <firmware EXPORT="copy">[CONTIKI_DIR]/examples/simulation/contikimac-srdcp/example-contikimac-srdcp.sky</firmware>
    ...
    <mote>
      ...
      <interface_config>
        ...
        <x>129.60138497800514</x>
        <y>61.786049871424154</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>119.38445923185816</x>
        <y>100.83212865668688</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspClock
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>103.5047147510667</x>
        <y>50.94694467279346</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspClock
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>85.46829422892728</x>
        <y>60.409077683594774</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspClock
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>147.80349643051713</x>
        <y>86.0461282200685</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspClock
...
if (LOG_DIR == null || LOG_DIR.isEmpty()) {
  LOG_DIR = new java.io.File("/home/chuongvo/waco/examples/contikimac-srdcp/sim/contikimac-srdcp-random-5-nodes").getPath();
}      // vd: "/home/user/cooja-logs" hay "C:\\temp\\cooja"
var LOG_BASENAME         = "contikimac-srdcp-random-5-nodes";      // sẽ tạo &lt;LOG_DIR&gt;/&lt;LOG_BASENAME&gt;.log và *_dc.log
...
while (true) {
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <skin>org.contikios.cooja.plugins.skins.TrafficVisualizerSkin</skin>
      <skin>org.contikios.cooja.plugins.skins.UDGMVisualizerSkin</skin>
      <viewport>1.6776627766045924 0.0 0.0 1.6776627766045924 46.13766945857855 38.56875167293177</viewport>
    </plugin_config>
    <width>400</width>
    <z>1</z>
    <height>400</height>
