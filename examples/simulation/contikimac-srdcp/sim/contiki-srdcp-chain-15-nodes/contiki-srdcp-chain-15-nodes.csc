...
<simconf>
  ...
  <simulation>
    <title>contikimac-srdcp-chain-15-nodes</title>
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>3.2574370909090895 0.0 0.0 3.2574370909090895 83.92578191515133 393.0364416</viewport>
    </plugin_config>
    <width>781</width>
    <z>-1</z>
    <height>794</height>
...
var LOG_BASENAME         = "contikimac-srdcp-chain-15-nodes";      // sẽ tạo &lt;LOG_DIR&gt;/&lt;LOG_BASENAME&gt;.log và *_dc.log
...
while (true) {
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <skin>org.contikios.cooja.plugins.skins.TrafficVisualizerSkin</skin>
      <skin>org.contikios.cooja.plugins.skins.UDGMVisualizerSkin</skin>
      <viewport>2.26210909090909 0.0 0.0 2.26210909090909 -42.3095854545455 162.58175999999995</viewport>
    </plugin_config>
    <width>400</width>
    <z>3</z>
    <height>400</height>
