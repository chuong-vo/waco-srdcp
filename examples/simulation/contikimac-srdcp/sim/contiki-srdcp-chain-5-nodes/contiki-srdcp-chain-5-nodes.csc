...
<simconf>
  ...
  <simulation>
    <title>contikimac-srdcpt-chain-5-nodes</title>
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>3.25743709090909 0.0 0.0 3.25743709090909 140.95074676363615 368.9476607999999</viewport>
    </plugin_config>
    <width>781</width>
    <z>1</z>
    <height>794</height>
...
var LOG_BASENAME         = "contikimac-srdcp-chain-5-nodes";      // sẽ tạo &lt;LOG_DIR&gt;/&lt;LOG_BASENAME&gt;.log và *_dc.log
