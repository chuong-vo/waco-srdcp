...
# Monte Carlo headless runs for the 5-node ContikiMAC random topology scenario
# Usage: mc_contiki_random_5nodes.sh [NUM_SEEDS] [OUTDIR]
...
OUTDIR=${2:-"$ROOT_DIR/examples/waco-srdcp/sim/out/contiki-srdcp-random-5-nodes-mc"}

COOJA_BUILD_XML="$ROOT_DIR/tools/cooja/build.xml"
SCEN="$ROOT_DIR/examples/waco-srdcp/sim/contiki-srdcp-random-5-nodes/waco-srdcp-random-5-nodes.csc"
LOGDIR="$ROOT_DIR/examples/waco-srdcp/sim/contiki-srdcp-random-5-nodes"
BASENAME="contiki-srdcp-random-5-nodes"
