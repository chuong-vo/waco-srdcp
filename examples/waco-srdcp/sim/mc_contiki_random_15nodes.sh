...
# Monte Carlo headless runs for the 15-node ContikiMAC random topology scenario
# Usage: mc_contiki_random_15nodes.sh [NUM_SEEDS] [OUTDIR]
...
OUTDIR=${2:-"$ROOT_DIR/examples/waco-srdcp/sim/out/contiki-srdcp-random-15-nodes-mc"}

COOJA_BUILD_XML="$ROOT_DIR/tools/cooja/build.xml"
SCEN="$ROOT_DIR/examples/waco-srdcp/sim/contiki-srdcp-random-15-nodes/waco-srdcp-random-15-nodes.csc"
LOGDIR="$ROOT_DIR/examples/waco-srdcp/sim/contiki-srdcp-random-15-nodes"
BASENAME="contiki-srdcp-random-15-nodes"
