...
# Monte Carlo headless runs for the 30-node ContikiMAC random topology scenario
# Usage: mc_contiki_random_30nodes.sh [NUM_SEEDS] [OUTDIR]
...
OUTDIR=${2:-"$ROOT_DIR/examples/waco-srdcp/sim/out/contiki-srdcp-random-30-nodes-mc"}

COOJA_BUILD_XML="$ROOT_DIR/tools/cooja/build.xml"
SCEN="$ROOT_DIR/examples/waco-srdcp/sim/contiki-srdcp-random-30-nodes/waco-srdcp-random-30-nodes.csc"
LOGDIR="$ROOT_DIR/examples/waco-srdcp/sim/contiki-srdcp-random-30-nodes"
BASENAME="contiki-srdcp-random-30-nodes"
