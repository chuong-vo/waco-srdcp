...
<simconf>
  ...
  <simulation>
    <title>contiki-srdcp-random-15-nodes</title>
...
if (LOG_DIR == null || LOG_DIR.isEmpty()) {
  LOG_DIR = new java.io.File("/home/chuongvo/waco/examples/waco-srdcp/sim/contiki-srdcp-random-15-nodes").getPath();
}      // vd: "/home/user/cooja-logs" hay "C:\\temp\\cooja"
var LOG_BASENAME         = "contiki-srdcp-random-15-nodes";      // sẽ tạo &lt;LOG_DIR&gt;/&lt;LOG_BASENAME&gt;.log và *_dc.log
