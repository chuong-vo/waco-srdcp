...
<simconf>
  ...
  <simulation>
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>211.88404383815026</x>
        <y>38.64942045472062</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspClock
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>-21.557375753371872</x>
        <y>34.49127953757226</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspClock
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>-16.107656138728323</x>
        <y>17.47901459730252</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspClock
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>1.3167579537660556 0.0 0.0 1.3167579537660556 558.203390320385 151.1441050162115</viewport>
    </plugin_config>
    <width>836</width>
    <z>1</z>
    <height>400</height>
  ...
  <plugin>
    ...
    <z>5</z>
    <height>400</height>
    <location_x>1783</location_x>
    <location_y>895</location_y>
  </plugin>
  <plugin>
