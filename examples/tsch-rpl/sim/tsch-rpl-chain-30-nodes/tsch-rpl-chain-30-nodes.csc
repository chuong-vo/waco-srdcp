...
<simconf>
  ...
  <simulation>
    <title>tsch-rpl-chain-30-nodes</title>
    ...
    <motetype>
      ...
      <source EXPORT="discard">[CONTIKI_DIR]/examples/tsch-rpl/example-tsch-rpl-30.c</source>
      <commands EXPORT="discard">make example-tsch-rpl-30.z1 TARGET=z1</commands>
      <firmware EXPORT="copy">[CONTIKI_DIR]/examples/tsch-rpl/example-tsch-rpl-30.z1</firmware>
...
if (LOG_DIR == null || LOG_DIR.isEmpty()) {
  LOG_DIR = new java.io.File("/home/chuongvo/waco/examples/tsch-rpl/sim/tsch-rpl-chain-30-nodes").getPath();
}
var LOG_BASENAME         = "tsch-rpl-chain-30-nodes";
