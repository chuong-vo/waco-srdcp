...
<simconf>
  ...
  <simulation>
    <title>tsch-rpl-grid-5-nodes</title>
...
if (LOG_DIR == null || LOG_DIR.isEmpty()) {
  LOG_DIR = new java.io.File("/home/chuongvo/waco/examples/tsch-rpl/sim/tsch-rpl-grid-5-nodes").getPath();
}
var LOG_BASENAME         = "tsch-rpl-grid-5-nodes";
