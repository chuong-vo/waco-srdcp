...
# Monte Carlo headless runs cho kịch bản GRID 15-node (tsch-rpl)
# Usage: mc_tsch_rpl_grid_15nodes.sh [NUM_SEEDS] [OUTDIR]
...
OUTDIR=${2:-"$ROOT_DIR/examples/tsch-rpl/sim/out/tsch-rpl-grid-15-nodes-mc"}

COOJA_BUILD_XML="$ROOT_DIR/tools/cooja/build.xml"
SCEN="$ROOT_DIR/examples/tsch-rpl/sim/tsch-rpl-grid-15-nodes/tsch-rpl-grid-15-nodes.csc"
LOGDIR="$ROOT_DIR/examples/tsch-rpl/sim/tsch-rpl-grid-15-nodes"
BASENAME="tsch-rpl-grid-15-nodes"
