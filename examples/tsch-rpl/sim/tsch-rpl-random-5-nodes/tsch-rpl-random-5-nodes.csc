...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <source EXPORT="discard">[CONTIKI_DIR]/examples/tsch-rpl/example-tsch-rpl.c</source>
      <commands EXPORT="discard">make example-tsch-rpl.z1 TARGET=z1</commands>
      <firmware EXPORT="copy">[CONTIKI_DIR]/examples/tsch-rpl/example-tsch-rpl.z1</firmware>
...
if (LOG_DIR == null || LOG_DIR.isEmpty()) {
  LOG_DIR = new java.io.File("/home/chuongvo/waco/examples/tsch-rpl/sim/tsch-rpl-random-5-nodes").getPath();
}
