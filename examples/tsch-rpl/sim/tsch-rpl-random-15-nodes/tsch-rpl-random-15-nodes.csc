...
<simconf>
  ...
  <simulation>
    <title>tsch-rpl-random-15-nodes</title>
...
if (LOG_DIR == null || LOG_DIR.isEmpty()) {
  LOG_DIR = new java.io.File("/home/chuongvo/waco/examples/tsch-rpl/sim/tsch-rpl-random-15-nodes").getPath();
}
var LOG_BASENAME         = "tsch-rpl-random-15-nodes";
