...
# Usage: mc_tsch_rpl_chain_30nodes.sh [NUM_SEEDS] [OUTDIR]
...
OUTDIR=${2:-"$ROOT_DIR/examples/tsch-rpl/sim/out/tsch-rpl-chain-30-nodes-mc"}

COOJA_BUILD_XML="$ROOT_DIR/tools/cooja/build.xml"
SCEN="$ROOT_DIR/examples/tsch-rpl/sim/tsch-rpl-chain-30-nodes/tsch-rpl-chain-30-nodes.csc"
LOGDIR="$ROOT_DIR/examples/tsch-rpl/sim/tsch-rpl-chain-30-nodes"
BASENAME="tsch-rpl-chain-30-nodes"
