...
# Monte Carlo headless runs cho kịch bản RANDOM 30-node (tsch-rpl)
# Usage: mc_tsch_rpl_random_30nodes.sh [NUM_SEEDS] [OUTDIR]
...
OUTDIR=${2:-"$ROOT_DIR/examples/tsch-rpl/sim/out/tsch-rpl-random-30-nodes-mc"}

COOJA_BUILD_XML="$ROOT_DIR/tools/cooja/build.xml"
SCEN="$ROOT_DIR/examples/tsch-rpl/sim/tsch-rpl-random-30-nodes/tsch-rpl-random-30-nodes.csc"
LOGDIR="$ROOT_DIR/examples/tsch-rpl/sim/tsch-rpl-random-30-nodes"
BASENAME="tsch-rpl-random-30-nodes"
