...
<simconf>
  ...
  <simulation>
    <title>tsch-rpl-grid-15-nodes</title>
    ...
    <motetype>
      ...
      <source EXPORT="discard">[CONTIKI_DIR]/examples/tsch-rpl/example-tsch-rpl-15.c</source>
      <commands EXPORT="discard">make example-tsch-rpl-15.z1 TARGET=z1</commands>
      <firmware EXPORT="copy">[CONTIKI_DIR]/examples/tsch-rpl/example-tsch-rpl-15.z1</firmware>
    ...
    <!-- 15-node grid, coordinates copied from SRDCP -->
...
if (LOG_DIR == null || LOG_DIR.isEmpty()) {
  LOG_DIR = new java.io.File("/home/chuongvo/waco/examples/tsch-rpl/sim/tsch-rpl-grid-15-nodes").getPath();
}
var LOG_BASENAME         = "tsch-rpl-grid-15-nodes";
