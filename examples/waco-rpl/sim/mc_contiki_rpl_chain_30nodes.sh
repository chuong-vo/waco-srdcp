...
OUTDIR=${2:-"$ROOT_DIR/examples/waco-rpl/sim/out/contiki-rpl-chain-30-nodes-mc"}

COOJA_BUILD_XML="$ROOT_DIR/tools/cooja/build.xml"
SCEN="$ROOT_DIR/examples/waco-rpl/sim/contiki-rpl-chain-30-nodes/contiki-rpl-chain-30-nodes.csc"
LOGDIR="$ROOT_DIR/examples/waco-rpl/sim/contiki-rpl-chain-30-nodes"
BASENAME="contiki-rpl-chain-30-nodes"
