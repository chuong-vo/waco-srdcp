...
# Monte Carlo for waco-rpl chain 5 nodes
# Usage: mc_rpl_chain_5nodes.sh [NUM_SEEDS] [OUTDIR]

NUM_SEEDS=${1:-10}
SCRIPT_DIR="$(cd "$(dirname "$0")" && pwd)"
ROOT_DIR="$(cd "$SCRIPT_DIR/../../.." && pwd)"
OUTDIR=${2:-"$ROOT_DIR/examples/waco-rpl/sim/out/waco-rpl-chain-5-nodes-mc"}

COOJA_BUILD_XML="$ROOT_DIR/tools/cooja/build.xml"
SCEN="$ROOT_DIR/examples/waco-rpl/sim/waco-rpl-chain-5-nodes/waco-rpl-chain-5-nodes.csc"
LOGDIR="$ROOT_DIR/examples/waco-rpl/sim/waco-rpl-chain-5-nodes"
BASENAME="waco-rpl-chain-5-nodes"
