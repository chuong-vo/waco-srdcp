...
# Monte Carlo headless runs cho kịch bản GRID 30-node (waco-rpl)
# Usage: mc_rpl_grid_30nodes.sh [NUM_SEEDS] [OUTDIR]
# - NUM_SEEDS: số lần chạy (mặc định 10)
# - OUTDIR: thư mục lưu kết quả (mặc định examples/waco-rpl/sim/out/waco-rpl-grid-30-nodes-mc)
...
OUTDIR=${2:-"$ROOT_DIR/examples/waco-rpl/sim/out/waco-rpl-grid-30-nodes-mc"}

COOJA_BUILD_XML="$ROOT_DIR/tools/cooja/build.xml"
SCEN="$ROOT_DIR/examples/waco-rpl/sim/waco-rpl-grid-30-nodes/waco-rpl-grid-30-nodes.csc"
LOGDIR="$ROOT_DIR/examples/waco-rpl/sim/waco-rpl-grid-30-nodes"
BASENAME="waco-rpl-grid-30-nodes"
